...
> **Status:** Pre-1.0. The schema and protocol specifications are versioned independently of package versions. See [`spec-schema.md`](./spec-schema.md) for versioning rules.
...
This is opt-in infrastructure for site owners. It does not scrape unannotated websites, bypass CAPTCHAs, or evade bot detection. Read [`../SECURITY.md`](../SECURITY.md) for the authorization model and [`anti-patterns.md`](./anti-patterns.md) for architectural boundaries.
...
| ---------------------------------------------- | ------------------------ | -------------------------------------------------------------------------- |
| [`spec-schema.md`](./spec-schema.md)           | Form authors, developers | Schema definition format, field types, constraints, conditional visibility |
| [`spec-protocol.md`](./spec-protocol.md)       | Integration engineers    | Discovery format, REST endpoints, in-page JS bridge, MCP tools             |
| [`architecture.md`](./architecture.md)         | Contributors             | Package boundaries, data flow, and runtime constraints                     |
| [`coding-standards.md`](./coding-standards.md) | Contributors             | TypeScript guidelines, error patterns, and testing conventions             |
| [`deployment.md`](./deployment.md)             | Operators                | Self-hosting, cloud deployment, and rate-limiting setup                    |
